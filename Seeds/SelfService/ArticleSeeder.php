...
class ArticleSeeder extends Seeder
{
    ...
    public function run()
    {
        $authorId = User::operator()->firstOrFail()->id;
...
<p>&nbsp;</p>
<pre class="language-php"><code>$SIMPLEAUTH_KEY = "RhqFi31PpIe0eIyP08fNqA";</code></pre>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<pre class="language-php"><code>md5($email . $SIMPLEAUTH_KEY . $time)</code></pre>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<pre class="language-php"><code>login.php?email=test@test.com&amp;
time=1423680791&amp;hash=bdc391437d78377767b5d435356e04eb&amp;back=http://domain.com/clientarea.php</code></pre>
<p>&nbsp;</p>
<h2>Errors</h2>
...
<p>&nbsp;</p>
<pre class="language-markup"><code>* * * * * php -q /&lt;base_path&gt;/includes/cron.php</code></pre>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<pre class="language-markup"><code>* * * * * /usr/bin/php -q /&lt;base_path&gt;/includes/cron.php</code></pre>
<p>&nbsp;</p>
...
<p>&nbsp;</p>
<pre class="language-php"><code>$ADMIN_FOLDER = "admin";</code></pre>
<p>&nbsp;</p>
